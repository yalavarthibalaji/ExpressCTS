...
public class RejectRepairServiceImpl implements RejectRepairService {
    ...
    /**
     * Overloaded saveRepair that accepts batchId explicitly.
     * Called from the composer, which already holds currentBatchId in state.
     * This avoids touching cheque.getBatch() entirely, preventing
     * LazyInitializationException on detached entities.
     */
