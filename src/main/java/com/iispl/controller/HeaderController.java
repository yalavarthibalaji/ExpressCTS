 ...
 * Role     : Reusable header component controller
 *
 * Reads the "loggedInUser" session attribute (UserModel) and
 * populates the header avatar, user name, and role badge.
 * Also handles the Sign Out (logout) button.
 */
public class HeaderController extends SelectorComposer<Component> {

    // ── Wired components from header.zul ──────────────────────────────
    @Wire("#headerRoleBadge")  private Div   headerRoleBadge;
    @Wire("#headerAvatar")     private Div   headerAvatar;
    @Wire("#headerUserName")   private Label headerUserName;
    @Wire("#btnHeaderLogout")  private org.zkoss.zul.Button btnHeaderLogout;
    ...
    public void doAfterCompose(Component comp) throws Exception {
        ...
        headerRoleBadge.appendChild(new org.zkoss.zul.Label(
