...
/**
 * OutwardCheque.java
 * Entity class representing one cheque in the outward clearing batch.
 *
 * Package  : com.iispl.entity
 * Pattern  : MVC — Entity / Model layer
 *
 * Fields are mapped 1-to-1 with XML tag names from the scanner file.
 * Additional runtime fields (makerStatus, checkerStatus, etc.) track workflow state.
 */
public class OutwardCheque {
    ...
    public String getDepositorAcc()                 { return depositorAcc; }
    public void   setDepositorAcc(String v)         { this.depositorAcc = v; }
    ...
    public boolean isIqaManualEntry()               { return iqaManualEntry; }
    public void    setIqaManualEntry(boolean v)     { this.iqaManualEntry = v; }

    public String getIqaOfficerRemarks()            { return iqaOfficerRemarks; }
    public void   setIqaOfficerRemarks(String v)    { this.iqaOfficerRemarks = v; }
    ...
    public String toString() {
        return "OutwardCheque{id='" + id + "', chequeNumber='" + chequeNumber +
               "', amount=" + amountInFigures + ", makerStatus='" + makerStatus + "'}";
    }
}