...
/**
 * UserModel.java Represents a user in the ExpressCTS system.
 *
 * Package : com.iispl.cts.model Pattern : MVC — Model layer
 *
 * Contains all properties needed for: - Login authentication - Role-based
 * navigation - Session display (header avatar, name, role badge)
 */
